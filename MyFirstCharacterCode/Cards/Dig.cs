...
public class Dig() : MyFirstCharacterCard(2,
    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        await PowerCmd.Apply<EnergyNextTurnPower>(choiceContext, Owner.Creature, DynamicVars.Energy.BaseValue, this.Owner.Creature,this);
    }
